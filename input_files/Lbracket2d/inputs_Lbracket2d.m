...
no_ele_size = FE.mesh_input.L_side/FE.mesh_input.L_element_size;
FE.mesh_input.elements_per_side = [no_ele_size no_ele_size]; % ***
%% =======================================================================
%% Boundary conditions
    ...
    FE.mesh_input.bcs_file = 'input_files/Lbracket2d/ACS/h1_P10_r25/setup_bcs_Lbracket2d.m';
...
% functions:
    ...
    OPT.functions.objective = 'volume fraction'; % maximum stress violation, volume fraction
...
%
    ...
    OPT.parameters.aggregation_parameter = 12;
