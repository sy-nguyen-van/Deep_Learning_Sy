...
FE.mesh_input.box_dimensions = [30 10];
FE.dim_scale = 3;
FE.mesh_input.elements_per_side = FE.dim_scale*FE.mesh_input.box_dimensions;
...
FE.mesh_input.bcs_file = 'input_files/cantilever2d/setup_bcs_cantilever2d.m';
...
OPT.functions.objective = 'volume fraction'; % maximum stress violation
OPT.functions.objective_scale = 1;
% Names of inequality (<=) constraints
OPT.functions.constraints = {'maximum stress violation'}; % volume fraction
...
OPT.parameters.aggregation_parameter = 10;
...
OPT.options.vtk_output_path = 'output_files/Lbracket2d/ACS/h1_P10_r25/';
% Path to write .mat file with densities for current design
OPT.options.mat_output_path = 'output_files/Lbracket2d/ACS/h1_P10_r25/';
% Path to save files if requested
OPT.options.outputs_path = strcat('output_files/Lbracket2d/ACS/h1_P10_r25/');
