function inputs_cracked_plate2d()
%% Input file 
%
...
%% Boundary conditions
    ...
    FE.mesh_input.bcs_file = 'input_files/cracked_plate2d/ACS/setup_bcs_cracked_plate2d.m';
...
%
    ...
    FE.material.E = 7e4; % Young's modulus of the design material
    FE.material.nu = 0.25; % Poisson ratio of the design material

    FE.material.rho_min = 1e-3; % Minimum density in void region
    FE.material.nu_void = 0.25;  % Poisson ratio of the void material
...
% functions:
    ...
    OPT.functions.constraint_limit = [0]; % ***
...
%   Suggested: aggregation_parameter = 6, aggregation_function = 'p-norm'
%
% For MRF:
%   Required: aggregation_type = 'mrf', ACS.use = false
%   Suggested: aggregation_parameter = 8, rectifier_parameter = 24,
...
%
    ...
    % parameters
    OPT.parameters.continuation = false;
    ...
    OPT.parameters.aggregation_function = 'p-norm';
    ...
    OPT.parameters.slimit = 100;
    % Adaptive constraint scaling
    OPT.parameters.ACS.use = true;
...
%% Optimization parameters
    ...
    OPT.options.vtk_output_path = 'output_files/cracked_plate2d/ACS/';
    % Path to write .mat file with densities for current design
    OPT.options.mat_output_path = 'output_files/cracked_plate2d/ACS/';
    % Path to save files if requested
    OPT.options.outputs_path = strcat('output_files/cracked_plate2d/ACS/');    
